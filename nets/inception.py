...
def inception_v3(images,
  ...
  with tf.variable_scope(scope, "InceptionV3", [images], reuse=tf.AUTO_REUSE) as scope:
    with slim.arg_scope(
...
def inception_v4(images,
  ...
  with tf.variable_scope(scope, "InceptionV4", [images], reuse=tf.AUTO_REUSE) as scope:
    with slim.arg_scope(
        [slim.conv2d, slim.fully_connected],
        weights_regularizer=weights_regularizer,
        trainable=trainable):
