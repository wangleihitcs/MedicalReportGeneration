...
class Model(object):
    ...
    def build_cnn(self):
        net, end_points = vgg.vgg_19(self.images, num_classes=1000, trainable=False, is_training=True)

        # self.local_visual_feats = end_points['vgg_19/conv5/conv5_4']
        self.visual_feats = tf.reshape(end_points['vgg_19/fc7'], shape=[self.batch_size, 4096])
